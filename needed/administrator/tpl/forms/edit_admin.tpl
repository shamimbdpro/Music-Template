				<div class="box">
                  <div id="collapse2" class="body">
                    <form class="form-horizontal form-edit" id="popup-validation">
					  <input type="hidden" name="form_type" value="edit_admin" />
					  <input type="hidden" name="id" value="[@id]" />
                      <div class="form-group">
                        <label class="control-label col-lg-4">Full name * </label>
                        <div class="col-lg-4">
                          <input type="text" class="validate[required] form-control" value="[@fullname]" name="fullname" id="fullname">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-lg-4">Username * </label>
                        <div class="col-lg-4">
                          <input type="text" class="validate[required] form-control" value="[@username]" name="name" id="name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-lg-4">E-mail *</label>
                        <div class=" col-lg-4">
                          <input class="validate[required,custom[email]] form-control" value="[@email]" type="text" name="email" id="email" />
                        </div>
                      </div>
                      <div class="form-group hide hidden">
                        <label class="control-label col-lg-4">Admin level</label>
                        <div class="col-lg-4">
                          <select name="level" id="level" class="validate[] form-control">
