                  ...
                  <div id="collapse2" class="body">
                    <form class="form-horizontal form-add" id="popup-validation">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-5">Class title * </label>
                        <div class="col-lg-5">
                          <input type="text" class="validate[required] form-control" name="title">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-lg-5">Class number * </label>
                        <div class="col-lg-5">
                          <input type="text" class="validate[required] form-control" name="number">
                        </div>
                      </div>
                      <div class="form-group">
