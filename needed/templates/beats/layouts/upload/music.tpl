              ...
              <select data-required="true" name="music_cat" required="required" title="Fill this field" class="form-control parsley-validated">
                <option value="">[@LANG_CHOOSE_CAT]</option>
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-10">
							<select data-required="true" name="music_album" title="Fill this field" class="form-control parsley-validated">
								<option value="">[@LANG_CHOOSE_ALBUM] </option>
                                [@albums]
                          </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
						  <div class="input-group m-b">
							  <input type="text" class="form-control" name="tags" placeholder="Add tags like this Music,POP, ...">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <label class="switch">
                          <input type="checkbox" name="music_public" checked >
                          <span></span>
                        </label>
                      </div>
                    </div>
