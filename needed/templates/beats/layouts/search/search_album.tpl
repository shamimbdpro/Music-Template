                    ...
                    <div class="col-md-12 marbot40 martop10">
						<div class="col-xs-4 col-lg-2 col-md-3" >
                          <a data-ajax="true" href="[@url]user/[@author_name]"><img src="[@url]image.php?src=[@cover]&w=820&h=600&img=al" alt="" class="r r-2x img-full"></a>
						</div>
						<div class="col-xs-8 col-lg-10 col-md-9">
							
							<a class="btn btn-default pull-right" data-toggle="button" id="item_action" data-type="albums" data-target="like" data-id="[@id]">
							...
							<a data-ajax="true" href="[@url]album/[@author_name]/[@playlist_url]" class="text-ellipsis">[@title]</a>
