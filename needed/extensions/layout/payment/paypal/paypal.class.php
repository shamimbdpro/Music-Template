...
class paypalClass {
   ...
   function check_config() {
		...
		$this->dbaser->where('link', 'paypal');
		$plugin = $this->dbaser->getOne('plugins');

		if (isset($plugin['id'])) {

			$this->dbaser->where('plugin_id', $plugin['id']);
			$content = $this->dbaser->getOne('plugins_options');
   ...
   function validate_ipn() {
      ...
      if (preg_match("/VERIFIED/",$this->response)) {
