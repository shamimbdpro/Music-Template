...
$params = array(
	"testmode"   => "on",
	"public_live_key"  => "pk_test_1UUhb4HpfMcQPsdhQZvLjIgs",
	"private_live_key" => "sk_test_N3rZxiXVowuHQTrwtOQOOJgz",
	"public_test_key"  => "pk_test_1UUhb4HpfMcQPsdhQZvLjIgs"
	"private_test_key" => "sk_test_N3rZxiXVowuHQTrwtOQOOJgz",
);
